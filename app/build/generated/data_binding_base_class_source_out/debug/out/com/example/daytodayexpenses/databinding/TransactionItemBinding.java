...
public final class TransactionItemBinding implements ViewBinding {
  ...
  private TransactionItemBinding(@NonNull LinearLayout rootView, @NonNull TextView amountTextView,
      @NonNull TextView dateTextView, @NonNull TextView noteTextView) {
  ...
  public static TransactionItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TransactionItemBinding((LinearLayout) rootView, amountTextView, dateTextView,
          noteTextView);
    }
