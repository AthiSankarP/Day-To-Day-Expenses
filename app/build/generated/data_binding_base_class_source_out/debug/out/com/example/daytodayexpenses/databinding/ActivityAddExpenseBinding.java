...
public final class ActivityAddExpenseBinding implements ViewBinding {
  ...
  private ActivityAddExpenseBinding(@NonNull RelativeLayout rootView, @NonNull EditText amount,
      @NonNull EditText category, @NonNull EditText date, @NonNull EditText description,
  ...
  public static ActivityAddExpenseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddExpenseBinding((RelativeLayout) rootView, amount, category, date,
