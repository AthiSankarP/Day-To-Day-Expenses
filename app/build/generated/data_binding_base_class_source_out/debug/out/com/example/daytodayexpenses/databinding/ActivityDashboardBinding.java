...
public final class ActivityDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final Button viewExpensesButton;

  private ActivityDashboardBinding(@NonNull RelativeLayout rootView,
      @NonNull Button viewExpensesButton) {
    this.rootView = rootView;
    this.viewExpensesButton = viewExpensesButton;
  }
  ...
  public static ActivityDashboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.viewExpensesButton;
      Button viewExpensesButton = ViewBindings.findChildViewById(rootView, id);
      if (viewExpensesButton == null) {
        break missingId;
      }

      return new ActivityDashboardBinding((RelativeLayout) rootView, viewExpensesButton);
    }
